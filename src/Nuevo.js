...
import * as muniData from "C:/Users/daniela bonilla/Desktop/astu/my-astu/src/municipalities.json";
     ...
     {activeMuni && (
      ...
      onClose={() =>{
       ...
       >
         ...
         <h2 className= "myClassname" ><strong>Codigo : {activeMuni.properties.url}</strong></h2>
